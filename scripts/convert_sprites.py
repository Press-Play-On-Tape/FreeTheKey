...
convert_header(IMAGES + 'Block_12.png',                                                         BASE + 'Images.hpp', 'Block_12', 4, 11, 24)
convert_header(IMAGES + 'Block_13.png',                                                         BASE + 'Images.hpp', 'Block_13', 4, 11, 32)
convert_header(IMAGES + 'Block_21.png',                                                         BASE + 'Images.hpp', 'Block_21', 4, 21, 16)
convert_header(IMAGES + 'Block_31.png',                                                         BASE + 'Images.hpp', 'Block_31', 4, 31, 16)
convert_header(IMAGES + 'Key.png',                                                              BASE + 'Images.hpp', 'Key', 4, 21, 16)
convert_header(IMAGES + 'Cursor.png',                                                           BASE + 'Images.hpp', 'Cursor', 4, 11, 16)
